...
class Poll(models.Model):
    ...
    campaign = models.ForeignKey(Campaign, on_delete=models.SET_NULL, null=True, blank=True, related_name="polls")
    ...
    class Meta:
        db_table = 'polls'
        ordering = ['-created_at']
        indexes = [models.Index(fields=['-created_at']), models.Index(fields=['is_active', 'expires_at'])]
...
class Vote(models.Model):
    ...
    voter_user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, blank=True, related_name='votes')
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=['poll', 'voter_user'], condition=models.Q(voter_user__isnull=False), name='unique_user_vote_per_poll'),
            models.UniqueConstraint(fields=['poll', 'voter_ip'], condition=models.Q(voter_user__isnull=True), name='unique_ip_vote_per_poll'),
        ]
